            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12 product-description-wrap">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="/products/{{ $product->category_id }}">{{ $product->category->nama_kategori }}</a>
                        </li>
                        <li class="active">
                            Catalog
                        </li>
                        ...
                        <div class="product">
                            <div class="product-item hover-trigger">
                                ...
                                <div class="product-details">
                                    ...
                                    <span class="category">
                                        <a
                                            href="/products/{{ $produk->category_id }}">{{ $produk->category->nama_kategori }}</a>
                                    </span>
                                </div>
                                <span class="price">
                                    <ins>
    ...
    <script>
        $(function() {
            $('.add-to-cart').click(function(e) {
                member_id = {{ optional(Auth::guard('webmember')->user())->id }}
                product_id = {{ $product->id }}
                jumlah = $('.jumlah').val()
                total = ({{ $product->harga }} * jumlah) * 0.2
                is_checkout = 0
