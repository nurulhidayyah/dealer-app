                            ...
                            <div class="product-item clearfix">
                                <div class="product-img hover-trigger">
                                    <a href="/product/{{$product->id}}">
                                        <img src="/uploads/{{$product->gambar}}" alt="{{$product->nama_barang}}">
                                        <img src="/uploads/{{$product->gambar}}" alt="{{$product->nama_barang}}" class="back-img">
                                    </a>
                                    <div class="hover-2">
                                ...
                                <div class="product-details">
                                    ...
                                    <span class="category">
                                        <a
                                            href="/products/{{$product->category_id}}">{{$product->category->nama_kategori}}</a>
                                    </span>
                                </div>
