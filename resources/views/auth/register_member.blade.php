    ...
    <div class="flex py-10 md:py-20 px-5 md:px-32 bg-gray-200 min-h-screen">
        <div class="flex shadow w-full flex-col-reverse lg:flex-row">
            <div class="w-full lg:w-1/2 bg-white p-10 px-5 md:px-20">
                <h1 class="font-bold text-xl text-gray-700">Registrasi</h1>
                <p class="text-gray-600">Silahkan Daftar Terlebih Dahulu!</p>
                <br>
                ...
                <form action="/register_member" class="mt-10" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="my-3">
                    ...
                    <div class="my-3">
                        <label class="font-semibold" for="no_hp">Bukti KTP</label>
                        <input required type="file" placeholder="Bukti KTP" name="bukti_ktp" id="bukti_ktp"
                            class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
                    ...
                    <div class="my-5">
                        <button type="submit"
                            class="w-full rounded-full bg-blue-400 hover:bg-blue-600 text-white py-2">REGISTRASI</button>
                    </div>
                </form>
